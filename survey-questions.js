...
SURVEY.meta = {
  ...
  praise: {
    title: '찬양팀 설문',
    sections: ['섬기게 된 계기와 일정', '어떤 방식으로 섬기면 좋을지', '필요한 것과 다음 계획', '나눔과 기도'],
    intro: '이 설문은 익명입니다. 잘했는지 못했는지를 묻지 않습니다. 찬양으로 섬기시는 데 무엇이 부담이었고 무엇이 더 필요한지 알기 위한 설문입니다. 마지막에는 나누고 싶은 이야기와 기도제목을 적는 자리도 있습니다.'
  }
};
...
SURVEY.praise = [
  ...
  { id:'p8', type:'checkbox', section:3, required:false, other:true,
    title:'준비하고 섬기시는 과정에서 아쉬웠던 것이 있었다면 골라주세요.',
    hint:'해당되는 것을 모두 골라주세요',
    options:[
      '선곡이나 순서가 늦게 정해졌다',
      '악보·음원을 늦게 받았다',
      ...
      '연습할 공간이나 시간이 부족했다',
      '필요한 장비가 제때 준비되지 않았다',
      '누구에게 물어보고 결정해야 할지 불분명했다',
      '집회 전후로 준비하고 정리할 시간이 부족했다',
      '특별히 아쉬운 점은 없었다'
    ] },
  ...
  { id:'p13', type:'textarea', section:4, required:false,
    title:'함께 기도했으면 하는 기도제목이 있다면 적어주세요.',
    hint:'이 설문은 익명이라 개인적으로 연락드리기는 어렵습니다. 따로 이야기 나누고 싶으시면 담당 선생님께 직접 말씀해 주세요.' },
