...
SURVEY.meta = {
  ...
  teacher: {
    ...
    sections: [
      '기본 질문 및 역할 선택',
      '[담임선생님] 학생 인솔 & 관계 케어',
      '[헬퍼/담당자] 프로그램 기획 & 현장 운영',
      '[공통] 전체 진행, 타임테이블 & 시스템 개선'
    ],
...
SURVEY.student = [
  ...
  { id:'q6', type:'rank', section:2, required:true, pick:3,
    title:"수련회 활동 중 나에게 가장 기억에 남고 즐거웠던 프로그램 '3가지'를 순서대로 선택해 주세요.",
    options:PROGRAMS },
...
SURVEY.teacher = [
  ...
  { id:'q11', type:'textarea', section:3, required:false, showIf:T_HELPER,
    title:'[섬김의 영역] 헬퍼로서 섬길 때 자신의 역할이 무엇인지 분명히 알고, 그것에 따라 참여하였다고 생각하시나요?' },
  ...
  { id:'q15_keep', type:'textarea', section:4, required:false,
    title:'[최종 KPT] 다음 수련회에서도 꼭 유지했으면 하는 시스템/프로그램:' },

  { id:'q15_try', type:'textarea', section:4, required:false,
    title:'[최종 KPT] 문제점 해결을 위해 다음 수련회에서 꼭 바꿨으면 하는 대안:' }
];
