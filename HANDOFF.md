...
> 마지막 업데이트: 2026-09-01 (**3학기 새 반편성 배포** — 셀1~12+Sp1~6 폐지 → 1반~6반+고3-1~4(10반) 전환, 전 시스템 반영 + 회의록 수정/이력 + nav B안 + 공지·기도 관리 + 라인업 단계별 확정)
> 상세 기획·설계(국장단 포털): project/active/council-portal/ · 3학기 배포 상세: project/active/lineup-deploy/ (context·tasks 2파일)
...
- **목적**: 내수동교회 고등부 2026년 3학기 (9월~) 교사·관리자 운영 시스템
...
## 👨‍👩‍👧 대가족 매핑 (2026-09-01 3학기 기준 — CELL_FAMILY 참고)
...
- **GitHub**: Tommyseok
- **역할**: 내수동 고등부 교사 + 6반 담임(3학기부터) + 총무 (관리자)
