...
SUB = {
    1: '이승헌', 2: '조세경', 3: '',     4: '',
    5: '박해니', 6: '',     7: '송진우', 8: '이규리',
    9: '김주영', 10: '',    11: '김희원', 12: '오은규',
}
# 대가족장: 홀수 소그룹반 담임 겸임
LEADERS = {1: 1, 2: 3, 3: 5, 4: 7, 5: 9, 6: 11}

CELL_STUDENTS = {
    1:  [('권하율',1,'남'),('하은유',1,'여'),('홍기진',2,'남'),('오은수',1,'여'),('장지현',2,'여')],
    2:  [('강은교',2,'여'),('명주원',3,'남'),('조인상',3,'여'),('연해준',2,'남'),('유나린',2,'여')],
    3:  [('박지호',3,'여'),('한채은',3,'여'),('김라일',2,'남'),('안민혁',1,'남')],
    4:  [('원대연',2,'남'),('이준호',2,'남'),('오현우',1,'남'),('이빛가온',1,'남')],
    5:  [('민예원',2,'여'),('김도연',2,'여'),('전지훈',2,'남'),('임태민',2,'남'),('최지은',1,'여')],
    6:  [('조한나',1,'여'),('김한결',1,'남'),('김강은',1,'여'),('이서후',1,'여')],
    7:  [('조강인',3,'남'),('이에녹',3,'남'),('최민호',2,'남'),('박지웅',1,'남'),('송준원',1,'남')],
    8:  [('심희은',3,'여'),('김은우',3,'여'),('최가은',3,'여'),('양소희',2,'여')],
    9:  [('나정인',3,'여'),('주성',3,'남'),('곽지원',3,'남'),('서이수',3,'여'),('양인혁',3,'남'),('김다은',3,'여')],
    10: [('이주형',1,'여'),('유재희',2,'여'),('윤성하',1,'남'),('나호윤',1,'남'),('이소현',1,'여')],
    11: [('최유현',1,'여'),('이가영',2,'여'),('김준수',3,'남'),('최수지',1,'여'),('박동하',1,'남')],
    12: [('정태율',1,'남'),('정승빈',3,'여'),('김주하',2,'여'),('김정록',1,'남'),('김채은',2,'여')],
}
...
SPECIAL = {
    ...
    4: [('박시우',1,'남'),('김나현',2,'여'),('하어림',1,'남'),('박진서',3,'여'),('임소명',3,'여')],
    5: [('오희수',3,'여'),('박민주',1,'여'),('배유나',2,'여'),('장세민',3,'남'),('정원영',3,'남')],
...
def fmt_students(students):
    """학생 리스트 → '권하율(1남), 하은유(1여)'"""
    return [f'{n}({g}{x})' for n, g, x in students]
...
def main():
    ...
    c.setFont('Malgun', 9)
    c.drawString(M, title_y - 10*mm, '6 대가족반 · 12 소그룹반 + 6 Special · 총 83명 · 학생·학부모 공유용')
    ...
    footer_text = '* 학생 표기: 이름(학년+성별)  *Special: 장기결석자 회복 그룹 (목회자·별도 교사 케어)  *★ 가족장: 대가족반 리더'
    c.drawString(M, M, footer_text)
